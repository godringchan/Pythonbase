...
class Application(tk.Frame):
    ...
    def creatlabel(self):
        self.lablel = tk.Label(self, text="label的测试", width=10, height=2,
        bg="black", fg="yellow",)
        self.lablel.pack()

        self.lablel2 = tk.Label(self, text="多个label的测试", width=15, height=2,
                                bg="green", fg="red", font=("雅黑", 30))
        self.lablel2.pack()
        # 显示图像
        # global photo
        ...
        # self.lablel3.pack()
        self.lablel4 = tk.Label(self, text="小玉真漂亮\n胸又大\n性格好\n还很骚",
